cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -fgcse-sm -floop-optimize -falign-loops -falign-labels -falign-functions -falign-jumps -DPERFORMANCE_RUN=1  -lrt     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
