...
PATCHLEVEL = 6
SUBLEVEL = 32
EXTRAVERSION = .9-HP-SuperSonic-Professional-PreSR4
...
KBUILD_CFLAGS   := -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Wall
